...
import vip.proyi.base.Constant;
import vip.proyi.base.PublicResultConstant;
import vip.proyi.config.ResponseModel;
import vip.proyi.entity.User;
import vip.proyi.service.IUserService;
import vip.proyi.service.SpringContextBeanService;
import vip.proyi.util.JWTUtil;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    private void responseError(ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            out.print(JSONObject.toJSONString(ResponseModel.createByErrorCodeMessage(HttpStatus.BAD_REQUEST.value(), PublicResultConstant.UNAUTHORIZED)));
            out.flush();
        } catch (Exception e) {
            e.printStackTrace();
        }finally {
